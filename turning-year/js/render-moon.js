...
(function (global) {
  ...
  var FACE_CY = 494, FACE_R = 54, DIAL_R = 63;
  ...
  function render(month, days, opts) {
    ...
    parts.push('<text x="500" y="336" text-anchor="middle" font-size="22" ' +
      'font-weight="600" font-family="var(--serif)" fill="var(--moon)">' +
      esc(focus.moonPhaseName) + '</text>');
    parts.push('<text x="500" y="360" text-anchor="middle" font-size="9" ' +
      'letter-spacing="1.6" fill="var(--ink-3)">LUNAR DAY</text>');
    parts.push('<text x="500" y="396" text-anchor="middle" font-size="28" ' +
      'font-family="var(--serif)" fill="var(--ink)">' + focus.dayInMonth + '</text>');
    parts.push('<text x="500" y="416" text-anchor="middle" font-size="9" ' +
      'letter-spacing="1.6" fill="var(--ink-3)">OF ' + N + '</text>');
    /* The date, and the brightness last: the figure people reach for least. */
    parts.push('<text x="500" y="599" text-anchor="middle" font-size="11" ' +
      'fill="var(--ink-3)">' + esc(TZ.formatDate(tz, focus.date, 'short')) + '</text>');
    parts.push('<text x="500" y="679" text-anchor="middle" font-size="11" ' +
  ...
  function clock(info, opts) {
    ...
    p.push('<text x=' + q(CX) + ' y=' + q(CY + 80) + ' text-anchor="middle" ' +
